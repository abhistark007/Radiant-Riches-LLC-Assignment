...
function DisplayContainer(props) {
  return (
    <div className='max-lg:flex-col max-lg:h-auto w-[80%] bg-[#FFFFFF]  m-auto h-[255px] rounded-[12px] flex relative font-["Inter"] items-center  pl-10 pr-5 gap-10'>
        {/* Floating div 1 */}
        ...
        <div className='flex flex-col gap-3 justify-center h-full'>
            ...
            <div className='pl-6'>{props.highlight}</div>
